          ...
          if (provider.transactions.isEmpty) {
            return RefreshIndicator(
              ...
              child: ListView(
                children: const [
                  SizedBox(height: 100),
                  Center(child: Text('No transactions found.', style: TextStyle(color: Colors.grey, fontSize: 16))),
                ],
              ),
            );
          }
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  const Text('Total Paid', style: TextStyle(color: AppConstants.textLightColor)),
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  const Text('Change Returned', style: TextStyle(color: AppConstants.textLightColor)),
